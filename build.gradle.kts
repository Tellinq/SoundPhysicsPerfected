...
class Dependencies {
    ...
    val yarn_mappings = property("deps.yarn_mappings")
    val yarn_mappings_patch_neoforge_version = property("deps.yarn_mappings_patch_neoforge_version")
...
tasks.processResources {
    val props = buildMap {
        ...
        put("yarn_mappings", deps.yarn_mappings)
        ...
        if (loader.isNeoforge) {
            ...
            put("yarn_mappings_patch_neoforge_version", deps.yarn_mappings_patch_neoforge_version)
        }
    }
